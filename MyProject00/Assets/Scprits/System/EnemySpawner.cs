...
public class EnemySpawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(distance <= spawn_dis && _enemy_obj == null)
        {
            _enemy_obj = Instantiate(_enemy);
            _enemy_obj.transform.position = transform.position;
            transform.parent = _enemy_obj.transform;
        }
    }
}
